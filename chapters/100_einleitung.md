...
Die wunderschöne idee, – fast schon poetisch, dein gesamtes Musik-Koffer-Orchester als moderne Hommage an Beethovens „Ode an die Freude“ zu orchestrieren.
...
Erstelle 5 MIDI-Spuren (je Gerät, jeweiliger Kanal wie oben).

Lege die Noten aus obigem Beispiel in Spur 1–5.

Stelle Zoom L-6 als Audio-Interface ein.

Aktiviere in den Ableton-MIDI-Prefs:

„Output: Zoom L-6“ = Track ON + Sync ON

Starte Playback → alle Geräte spielen synchron.
